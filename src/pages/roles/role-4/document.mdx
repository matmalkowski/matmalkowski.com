...
- Working for the one of the largest OTA in the world as a full stack software developer - driving website changes from the back-end services based on ASP.NET (C#) to client-side code (TypeScript / JavaScript)
